...
import com.moutamid.tiptop.databinding.ActivityReceiverSignupBinding;
import com.moutamid.tiptop.models.UserModel;
import com.moutamid.tiptop.tiper_side.activities.LoginTiperActivity;
...
public class ReceiverSignupActivity extends AppCompatActivity {
    ActivityReceiverSignupBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityReceiverSignupBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        binding.toolbar.back.setOnClickListener(v -> onBackPressed());
        binding.toolbar.title.setText("Sign Up");

        binding.login.setOnClickListener(v -> startActivity(new Intent(this, ReceiverLoginActivity.class)));
